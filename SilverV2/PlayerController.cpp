...
{
	UE_LOG(LogFortSDK, Log, "ServerAcknowledgePossession Called.");
	...
	if (!CosmeticLoadout.GetCharacter())
		UE_LOG(LogFortSDK, Error, "CosmeticLoadout.Character null");

	if (CosmeticLoadout.GetCharacter())
	{
		UE_LOG(LogFortSDK, Log, "CosmeticLoadout.Character ok");
		UE_LOG(LogFortSDK, Log, "CosmeticLoadout.Character: %s", CosmeticLoadout.GetCharacter()->GetFName().ToString().ToString().c_str());
		...
		UE_LOG(LogFortSDK, Log, "CosmeticLoadout.GetCharacter()->GetHeroDefinition(): %s", CosmeticLoadout.GetCharacter()->GetHeroDefinition()->GetFName().ToString().ToString().c_str());
